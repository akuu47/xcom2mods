...
//---------------------------------------------------------------------------------------
class UISL_WotC_DOA_AyaneInfiltrator extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WotC_DOA_AyaneInfiltrator' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_DOA_AyaneInfiltrator.DOA5_Logo", 26, 26, -4) $ " ";
    }
    return "";
}
