//---------------------------------------------------------------------------------------
//  FILE:   XComDownloadableContentInfo_StrongerTemplarParry.uc                                    
//           
...
class X2DownloadableContentInfo_StrongerTemplarParry extends X2DownloadableContentInfo config(Game);

var config bool CanDeflectReflectOnParry;
