...
//---------------------------------------------------------------------------------------
class UISL_UICustomizeWOTC_Kerrigan_Squadmate extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WOTC_Kerrigan_Squadmate' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_SCII_Kerrigan.UIIcon_SCII_Icon", 26, 26, -4) $ " ";
    }
    return "";
}