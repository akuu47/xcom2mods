...
3. Navigate to and open the "RaidenVoicepackPkg.upk" file

## Importing a sound file
1. In the Content Browser window, press the "Import" button
2. Open your first sound file (e.g. "RaidenVoicepack_Dashing_01.wav")
...
2. Set the name to "RaidenVoicepack_Dashing_Cue" 
...
7. In the package contents pane, right-click on the RaidenVoicepack_Dashing_Cue object and choose "Sound Classes [...]" > "Voice"

## Hook the cue up to the Voice
1. In the package contents pane, right-click on the Archetype object (_RaidenVoicepackVoiceArchetype) and choose Properties
...
5. Expand this event
6. In the package contents pane, select the SoundCue "RaidenVoicepack_Cue_Dashing" object
