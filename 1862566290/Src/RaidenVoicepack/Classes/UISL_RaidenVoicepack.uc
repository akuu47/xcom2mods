...
//---------------------------------------------------------------------------------------
class UISL_RaidenVoicepack extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'MKRaidenVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///RaidenVoicepackPkg.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}