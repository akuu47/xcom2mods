...
//---------------------------------------------------------------------------------------
class UISL_UICustomize_MGRA extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'MGRSet' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///MGRArmor_Content.UI.Icon_MGR", 26, 26, -4) $ " ";
    }
    return "";
}
