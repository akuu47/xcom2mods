...
//---------------------------------------------------------------------------------------
class UISL_KenshiVoicepack extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'MKKenshiVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///KenshiPackage.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}