...
class UISL_UICustomiseTemplarHelmets extends UIScreenListener;
...
{
	if( BodyPart.DLCName == 'TemplarHelms' )
	{
		return class'UIUtilities_Text'.static.InjectImage("img:///TemplarHelmetUI.UI_TemplarHelms32x32", 26, 26, -4) $ " ";
	}
	return "";
}
