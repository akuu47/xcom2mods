...
//---------------------------------------------------------------------------------------
class UISL_UICustomizeWOTC_Nova_Squadmate extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WOTC_Nova_Squadmate' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///SCII_Nova_Assets.UIIcon_SCII_Icon", 26, 26, -4) $ " ";
    }
    return "";
}