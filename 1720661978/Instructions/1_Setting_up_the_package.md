...
2. Set the Package name to "ScorpionMKXPkg"
3. Set the Factory to "SoundCue"
4. Click "OK"

You MUST name the package "ScorpionMKXPkg".
...
4. Search for "RobojumperCharacterVoice_ScorpionMKX"
5. Right-click on RobojumperCharacterVoice_ScorpionMKX and choose "Create Archetype..."

6. Set the Package name to "ScorpionMKXPkg"
7. Set the Name to "_ScorpionMKXVoiceArchetype"
8. Click "OK"

You MUST name this object "_ScorpionMKXVoiceArchetype".
...
`%USERPROFILE%\Documents\Firaxis ModBuddy\XCOM\ScorpionMKX\ScorpionMKX\Content\ScorpionMKXPkg.upk` 
...
4. Navigate to and Add the "ScorpionMKXPkg.upk" file