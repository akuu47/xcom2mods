...
//---------------------------------------------------------------------------------------
class UISL_ScorpionMK extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'MKScorpionVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///ScorpionMKXPkg.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}