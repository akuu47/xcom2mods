...
//---------------------------------------------------------------------------------------
class UISL_UICustomizeWOTC_Hair_Pack extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WOTC_Hair_Pack' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///Hair_Fem_Assets.UIIcon_Kexx_Icon", 26, 26, -4) $ " ";
    }
	 else if( BodyPart.DLCName == 'AsteryHP' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///Hair_Fem_Assets_Astery.UI_Astery_Icon", 26, 26, -4) $ " ";
    }
    return "";
}
