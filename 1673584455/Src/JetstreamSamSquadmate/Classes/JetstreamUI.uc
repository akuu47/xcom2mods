...
//---------------------------------------------------------------------------------------
class JetstreamUI extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'JetstreamSamSquadmate' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_JetstreamSquadmate.Revengeance", 26, 26, -4) $ " ";
}
return "";
}