...
static function X2DataTemplate CreatePistolSlotTemplate()
{
	...
	//Template.GetBestGearForSlotFn = PistolGetBestGearForSlot;
...
/*function array<X2EquipmentTemplate> PistolGetBestGearForSlot(XComGameState_Unit Unit)
{
    ...
    arr.Length = 0;
    return XComHQ.GetItemByName('Pistol_CV');
}*/
