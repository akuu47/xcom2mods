...
//---------------------------------------------------------------------------------------
class UIScreenListener_Augments extends UIScreenListener;
...
{
	if( BodyPart.DLCName == 'Augments' )
	{
		return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_Augments.sparticon", 26, 26, -4) $ " ";
	}
	return "";
}
