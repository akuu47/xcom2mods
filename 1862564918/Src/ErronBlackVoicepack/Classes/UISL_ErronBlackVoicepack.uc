...
//---------------------------------------------------------------------------------------
class UISL_ErronBlackVoicepack extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'MKErronVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///ErronBlackVoicepackPkg.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}