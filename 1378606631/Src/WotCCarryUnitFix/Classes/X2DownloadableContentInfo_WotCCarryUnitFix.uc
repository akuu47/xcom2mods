//---------------------------------------------------------------------------------------
//  FILE:   XComDownloadableContentInfo_WotCCarryUnitFix.uc                                    
//           
...
class X2DownloadableContentInfo_WotCCarryUnitFix extends X2DownloadableContentInfo;
...
static event OnPostTemplatesCreated() {
	GiveCarryUnitWorkaround();
}

static function GiveCarryUnitWorkaround()
{
	...
	foreach CharManager.IterateTemplates(DifficultyTemplate, none) {
		...
		{
			CharTemplate.Abilities.AddItem('CarryUnitWorkaround');
