...
//---------------------------------------------------------------------------------------
class UIScreenListener_AugmentsWotC extends UIScreenListener;
...
{
	if( BodyPart.DLCName == 'AugmentsWotC' )
	{
		return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_AugmentsWotC.sparticon", 26, 26, -4) $ " ";
	}
	return "";
}
