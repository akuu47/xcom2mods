...
//---------------------------------------------------------------------------------------
class UISL_TakedaVoicepack extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'MKXTakedaVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///TakedaPackage.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}