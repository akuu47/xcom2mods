...
//---------------------------------------------------------------------------------------
class UISL_WotC_TD_Ryan extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'WotC_TD_Ryan' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_TD_Ryan.TD_Logo", 26, 26, -4) $ " ";
}
return "";
}
