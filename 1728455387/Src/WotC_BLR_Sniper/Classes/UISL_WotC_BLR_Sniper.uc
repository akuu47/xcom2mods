...
//---------------------------------------------------------------------------------------
class UISL_WotC_BLR_Sniper extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WotC_BLR_Sniper' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_BLR_Sniper.BLR_Logo", 26, 26, -4) $ " ";
    }
    return "";
}
