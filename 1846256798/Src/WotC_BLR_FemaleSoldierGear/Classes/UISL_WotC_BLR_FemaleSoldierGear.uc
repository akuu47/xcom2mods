...
//---------------------------------------------------------------------------------------
class UISL_WotC_BLR_FemaleSoldierGear extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WotC_BLR_FemaleSoldierGear' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_BLR_FemaleSoldierGear.BLR_Logo", 26, 26, -4) $ " ";
    }
    return "";
}
