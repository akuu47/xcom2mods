...
//---------------------------------------------------------------------------------------
class UISL_MKJacquiVoice extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'MKJacquiVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///JacquiPackage.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}