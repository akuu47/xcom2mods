...
//---------------------------------------------------------------------------------------
class UISL_WotC_CSO2_Viper extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'WotC_CSO2_Viper' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_CSO2_Viper.CSGO_Logo", 26, 26, -4) $ " ";
    }
    return "";
}
