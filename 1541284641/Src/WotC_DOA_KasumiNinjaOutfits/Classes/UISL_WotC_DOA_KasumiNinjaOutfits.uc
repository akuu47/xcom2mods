...
//---------------------------------------------------------------------------------------
class UISL_WotC_DOA_KasumiNinjaOutfits extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'WotC_DOA_KasumiNinjaOutfits' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_DOA_KasumiNinjaOutfits.DOA5_Logo", 26, 26, -4) $ " ";
}
return "";
}
