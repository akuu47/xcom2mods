...
//---------------------------------------------------------------------------------------
class UISL_CharacterPropPackWOTC extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'NewCPP' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///wotc_audioghoulcpp.CPPFlair", 26, 26, -4) $ " ";
}
return "";
}