...
class X2StrategyElement_HybridCovertAction extends X2StrategyElement;

static function array<X2DataTemplate> CreateTemplates()
{
	local array<X2DataTemplate> CovertActions;

	CovertActions.AddItem(CreateRecruitHybridSoldierTemplate());

	return CovertActions;
}
//---------------------------------------------------------------------------------------
// RECRUIT HYBRID SOLDIER
//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateRecruitHybridSoldierTemplate()
{
	local X2CovertActionTemplate Template;

	`CREATE_X2TEMPLATE(class'X2CovertActionTemplate', Template, 'CovertAction_RecruitHybridSoldier');
	...
	Template.Narratives.AddItem('CovertActionNarrative_RecruitHybridSoldier_Skirmishers');
	...
	Template.Rewards.AddItem('Reward_HybridSoldier');
