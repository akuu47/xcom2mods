...
//---------------------------------------------------------------------------------------
class UISL_UICustomize_SA2Leona extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'SA2Leona' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///SA2Leona_Content.UI.Icon_SA2", 26, 26, -4) $ " ";
    }
    return "";
}
