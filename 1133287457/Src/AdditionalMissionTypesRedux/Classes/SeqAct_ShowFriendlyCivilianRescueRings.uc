...
class SeqAct_ShowFriendlyCivilianRescueRings extends SequenceAction
...
function ModifyKismetGameState(out XComGameState GameState)
{
	...
	{
		if(((Unit.GetTeam() == eTeam_Neutral && Unit.GetMyTemplateName() != 'HostileCivilian') || (Unit.GetTeam() == eTeam_Resistance && bIncludeResistanceUnits)) && !Unit.IsDead())
		{
...
defaultproperties
{
	ObjName="Show Friendly Rescue Rings"
	RescueRingRadius=3
