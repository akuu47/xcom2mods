...
//           
//---------------------------------------------------------------------------------------
class X2Item_SMGWeapon extends X2Item config(LW_SMGPack_WotC);
...
static function X2DataTemplate CreateTemplate_SMG_Conventional()
{
	...
	//Template.AddDefaultAttachment('Reargrip', "ConvAssaultRifle.Meshes.SM_ConvAssaultRifle_ReargripA", , "img:///UILibrary_Common.ConvAssaultRifle.ConvAssault_ReargripA"); // reargrip not applicable to SMG
...
static function X2DataTemplate CreateTemplate_SMG_Magnetic()
{
	...
	//Template.GameArchetype = "LWSMG_MG_alt.WP_SMG_MG_alt";
...
static function X2DataTemplate CreateTemplate_SMG_Beam()
{
	...
	// This all the resources; sounds, animations, models, physics, the works.
	// TODO : update for SMG Beam model and default attachments
