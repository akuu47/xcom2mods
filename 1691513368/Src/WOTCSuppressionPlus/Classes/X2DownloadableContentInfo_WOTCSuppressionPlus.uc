//---------------------------------------------------------------------------------------
//  FILE:   XComDownloadableContentInfo_WOTCSuppressionPlus.uc                                    
//           
...
class X2DownloadableContentInfo_WOTCSuppressionPlus extends X2DownloadableContentInfo;
...
static event OnPostTemplatesCreated()
{
	...
	foreach class'X2Ability_SuppressionPlus'.default.SuppressionShotAbility(TemplateName)
	{
		class'X2Ability_SuppressionPlus'.static.PatchSuppressionPlusShot(TemplateName);
	}

	foreach class'X2Ability_SuppressionPlus'.default.SuppressionAbility(TemplateName)
	{
		class'X2Ability_SuppressionPlus'.static.PatchSuppressionNoFlank(TemplateName);
	}
}
