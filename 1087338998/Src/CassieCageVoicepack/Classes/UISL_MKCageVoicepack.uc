...
//---------------------------------------------------------------------------------------
class UISL_MKCageVoicepack extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'CassieVoice' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///Cassie_Pack2.icon_MKdragon", 26, 26, -4) $ " ";
}
return "";
}