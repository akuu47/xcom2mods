...
//---------------------------------------------------------------------------------------
class UIScreenListener_ReachReduxArmy extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'ReachReduxArmy' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_ReachTrooperPorts.UILibrary.doticon", 26, 26, -4) $ " ";
    }
    return "";
}
