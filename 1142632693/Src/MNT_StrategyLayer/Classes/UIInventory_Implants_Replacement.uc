class UIInventory_Implants_Replacement extends UIInventory;
...
simulated function bool CanEquipImplant(StateObjectReference ImplantRef)
{
	...
	Unit = UIArmory_MainMenu_Replacement(Movie.Pres.ScreenStack.GetScreen(class'UIArmory_MainMenu_Replacement')).GetUnit();
...
simulated function SelectedItemChanged(UIList ContainerList, int ItemIndex)
{
	...
	Unit = UIArmory_MainMenu_Replacement(Movie.Pres.ScreenStack.GetScreen(class'UIArmory_MainMenu_Replacement')).GetUnit();
	SoldierHeader = UIArmory_MainMenu_Replacement(Movie.Pres.ScreenStack.GetScreen(class'UIArmory_MainMenu_Replacement')).Header;
	SlotIndex = 0;
	EquippedImplants = Unit.GetAllItemsInSlot(eInvSlot_CombatSim);
...
simulated function RemoveImplant()
{
	...
	UnitRef = UIArmory_MainMenu_Replacement(Movie.Pres.ScreenStack.GetScreen(class'UIArmory_MainMenu_Replacement')).GetUnit().GetReference();
