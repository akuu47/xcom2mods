//---------------------------------------------------------------------------------------
//  FILE:    UIArmory_AdditionalAbilitiesColumn.uc
//  AUTHOR:  Joe Weinhoffer
//   
//---------------------------------------------------------------------------------------
//  Copyright (c) 2016 Firaxis Games, Inc. All rights reserved.
//---------------------------------------------------------------------------------------
class UIArmory_AdditionalAbilitiesColumn extends UIPanel;
...
function UIArmory_AdditionalAbilitiesColumn InitPromotionHeroColumn(int InitRank)
{
...
{
	local UIArmory_AdditionalAbilities PromotionScreen;
	
	PromotionScreen = UIArmory_AdditionalAbilities(Screen);
	...
	foreach AbilityIcons(AbilityIcon, idx)
	{
		if (Panel == AbilityIcon)
		{
			...
			else if (cmd == class'UIUtilities_Input'.const.FXS_L_MOUSE_IN)
			{
				...
				if( !UIArmory_AdditionalAbilities(Screen).IsAbilityLocked(Rank) )
				{
