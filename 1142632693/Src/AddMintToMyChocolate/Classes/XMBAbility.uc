...
// Matching weapon conditions that works as a shooter condition and checks types
var const X2Condition_ValidWeapon IsPistol;
var const X2Condition_ValidWeapon IsSidearm;
var const X2Condition_ValidWeapon IsBlade;
var const X2Condition_ValidWeapon IsRifle;
var const X2Condition_ValidWeapon IsShotgun;
var const X2Condition_ValidWeapon IsSniper;
var const X2Condition_ValidWeapon IsCannon;
var const X2Condition_ValidWeapon IsGREMLIN;
...
// Hides ability. For use with secondary abilities added in AdditionaAbilities that
// shouldn't get their own icon.
static function HidePerk(X2AbilityTemplate Template)
{
...
{
	//Some new defaults
	Begin Object Class=X2Condition_ValidWeapon Name=DefaultPistolCondition
		AllowedWeaponCategories[0]="pistol"
		AllowedWeaponCategories[1]="sidearm"
	End Object
	IsPistol = DefaultPistolCondition
	
	Begin Object Class=X2Condition_ValidWeapon Name=DefaultSidearmCondition
		AllowedWeaponCategories[0]="pistol"
		AllowedWeaponCategories[1]="sidearm"
		AllowedWeaponCategories[2]="arcthrower"
		AllowedWeaponCategories[3]="sawnoffshotgun"
	End Object
	IsSidearm = DefaultSidearmCondition

	Begin Object Class=X2Condition_ValidWeapon Name=DefaultBladeCondition
		AllowedWeaponCategories[0]="gauntlet"
		AllowedWeaponCategories[1]="sword"
		AllowedWeaponCategories[2]="combatknife"
	End Object
	IsBlade = DefaultBladeCondition

	Begin Object Class=X2Condition_ValidWeapon Name=DefaultRifleCondition
		AllowedWeaponCategories[0]="rifle"
	End Object
	IsRifle = DefaultRifleCondition

	Begin Object Class=X2Condition_ValidWeapon Name=DefaultShotgunCondition
		AllowedWeaponCategories[0]="shotgun"
	End Object
	IsShotgun = DefaultShotgunCondition

	Begin Object Class=X2Condition_ValidWeapon Name=DefaultSniperCondition
		AllowedWeaponCategories[0]="sniper_rifle"
	End Object
	IsSniper = DefaultSniperCondition

	Begin Object Class=X2Condition_ValidWeapon Name=DefaultCannonCondition
		AllowedWeaponCategories[0]="cannon"
	End Object
	IsCannon = DefaultCannonCondition

	Begin Object Class=X2Condition_ValidWeapon Name=DefaultGremlinCondition
		AllowedWeaponCategories[0]="gremlin"
	End Object
	IsGREMLIN = DefaultGremlinCondition
