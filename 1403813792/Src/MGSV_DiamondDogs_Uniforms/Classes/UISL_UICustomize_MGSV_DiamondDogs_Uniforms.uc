...
//---------------------------------------------------------------------------------------
class UISL_UICustomize_MGSV_DiamondDogs_Uniforms extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'MGSV_DiamondDogsUniform' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///MGSV_DD_BDU_Main_Assets.UI.UIIcon_DD", 26, 26, -4) $ " ";
    }
