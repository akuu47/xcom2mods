class X2Item_Grenade_Smoke_M18_T1 extends X2Item_Master_Data config(Item_MD_WOTC_MWR_GND_SMOKE_M18_STD_T1);
...
static function X2DataTemplate CreateM18SmokeGrenade()
{
	local X2GrenadeTemplate Template;
	local X2Effect_ResOrd_ApplySmokeGrenadeToWorld WeaponEffect;
	local ArtifactCost Resources;
	local int i;
	
	`CREATE_X2TEMPLATE(class'X2GrenadeTemplate', Template, 'MD_WOTC_MWR_GND_SMOKE_M18_STD_T1'); //TC_WOTC_GRENADE_FRAG_MWR_M67
	...
	Template.GameArchetype = "XZ_ResOrd_Data.Archetypes.WP_Grenade_Smoke_M18";
	...
	WeaponEffect = new class'X2Effect_ResOrd_ApplySmokeGrenadeToWorld';	
