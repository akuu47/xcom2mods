...
//  DESCRIPTION: Basically a carbon copy of X2Effect_ApplySmokeGrenadeToWorld.uc
//---------------------------------------------------------------------------------------
//  Copyright (c) 2016 Firaxis Games, Inc. All rights reserved.
//---------------------------------------------------------------------------------------
class X2Effect_ResOrd_ApplySmokeGrenadeToWorld extends X2Effect_World config(GameData);

var config string SmokeParticleSystemFill_Name;
var config string SmokeParticleSystemFill_White_Name;
...
*/
event array<ParticleSystem> GetParticleSystem_Fill_White()
{
	local array<ParticleSystem> ParticleSystems;
	ParticleSystems.AddItem(none);
	ParticleSystems.AddItem(ParticleSystem(DynamicLoadObject(SmokeParticleSystemFill_White_Name, class'ParticleSystem')));
	return ParticleSystems;
}
...
simulated function AddX2ActionsForVisualization(XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata, name EffectApplyResult)
{
	...
	if( ActionMetadata.StateObject_NewState.IsA('XComGameState_WorldEffectTileData') )
	{
		...
		AddSmokeAction.SetParticleSystems(GetParticleSystem_Fill_White());
