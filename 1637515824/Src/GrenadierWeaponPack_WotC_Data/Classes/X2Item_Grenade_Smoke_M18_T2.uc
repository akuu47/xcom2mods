class X2Item_Grenade_Smoke_M18_T2 extends X2Item_Master_Data config(Item_MD_WOTC_MWR_GND_SMOKE_M18_STD_T2);
...
static function X2DataTemplate CreateM18SmokeGrenade()
{
	...
	`CREATE_X2TEMPLATE(class'X2GrenadeTemplate', Template, 'MD_WOTC_MWR_GND_SMOKE_M18_STD_T2'); //TC_WOTC_GRENADE_FRAG_MWR_M67
