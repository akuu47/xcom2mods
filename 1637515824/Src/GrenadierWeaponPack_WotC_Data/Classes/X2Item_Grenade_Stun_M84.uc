class X2Item_Grenade_Stun_M84 extends X2Item_Master_Data config(Item_MD_WOTC_MWR_GND_STUN_M84_STD_T1);
...
static function X2DataTemplate CreateM84StunGrenade()
{
	...
	`CREATE_X2TEMPLATE(class'X2GrenadeTemplate', Template, 'MD_WOTC_MWR_GND_STUN_M84_STD'); //TC_WOTC_GRENADE_FRAG_MWR_M67
	...
	Template.GameArchetype = "XZ_ResOrd_Data.Archetypes.WP_Grenade_Flashbang_M84";
