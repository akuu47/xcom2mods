class X2Item_Grenade_EMP_IW_T1 extends X2Item_Master_Data config(Item_MD_WOTC_IW_GND_EMP_STD_T1);
...
static function X2DataTemplate CreateEMPIWGrenade()
{
	...
	`CREATE_X2TEMPLATE(class'X2GrenadeTemplate', Template, 'MD_WOTC_IW_GND_EMP_STD_T1'); //TC_WOTC_GRENADE_FRAG_MWR_M67
