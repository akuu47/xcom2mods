class X2Item_Weapon_GL_ChinaLake_Standard_XCOM extends X2Item_Master_Data config(Item_MD_WOTC_GL_CLK_STD);
...
static function X2GrenadeLauncherTemplate CreateItem_T1()
{
	...
	`CREATE_X2TEMPLATE(class'X2GrenadeLauncherTemplate', Template, 'MD_WOTC_GL_CLK_STD_T1'); //TC_WOTC_GRENADE_FRAG_MWR_M67
...
//	Template.BaseDamage = default.ItemBaseDamage_T1;
	...
	Template.GameArchetype = "XZ_ResOrd_Data.Archetypes.WP_Weapon_ChinaLake";
...
static function X2GrenadeLauncherTemplate CreateItem_T2()
{
	...
	`CREATE_X2TEMPLATE(class'X2GrenadeLauncherTemplate', Template, 'MD_WOTC_GL_CLK_STD_T2'); //TC_WOTC_GRENADE_FRAG_MWR_M67
