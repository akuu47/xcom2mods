class X2Item_Grenade_Frag_IW extends X2Item_Master_Data config(Item_MD_WOTC_IW_GND_FRAG_STD_T2);
...
static function X2DataTemplate CreateIWFragGrenade()
{
	...
	`CREATE_X2TEMPLATE(class'X2GrenadeTemplate', Template, 'MD_WOTC_IW_GND_FRAG_STD_T2'); //TC_WOTC_GRENADE_FRAG_MWR_M67
	...
	Template.GameArchetype = "XZ_ResOrd_Data.Archetypes.WP_Grenade_Frag_IW";
