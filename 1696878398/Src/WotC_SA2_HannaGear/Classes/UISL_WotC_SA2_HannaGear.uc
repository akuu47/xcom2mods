...
//---------------------------------------------------------------------------------------
class UISL_WotC_SA2_HannaGear extends UIScreenListener;
...
{
if( BodyPart.DLCName == 'WotC_SA2_HannaGear' )
{
return class'UIUtilities_Text'.static.InjectImage("img:///UILibrary_WotC_SA2_HannaGear.SA2_Logo", 26, 26, -4) $ " ";
}
return "";
}
