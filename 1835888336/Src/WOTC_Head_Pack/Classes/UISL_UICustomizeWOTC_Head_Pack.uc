...
//---------------------------------------------------------------------------------------
class UISL_UICustomizeWOTC_Head_Pack extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'Head_Pack' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///Head_Pack_Assets.UIIcon_Horse_Icon", 26, 26, -4) $ " ";
    }
    return "";
}
