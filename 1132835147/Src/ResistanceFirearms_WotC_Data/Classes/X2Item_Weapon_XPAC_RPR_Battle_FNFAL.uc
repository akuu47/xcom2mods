//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_RPR_Battle_G3.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_RPR_Battle_FNFAL extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_RPR_CTM_FNFAL);
