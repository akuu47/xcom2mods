//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_TMP_Pistol_USP45.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_TMP_Pistol_USP45 extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_TMP_MWR_USP45);
