//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_SKR_SMG_MP5.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_SKR_SMG_UMP45 extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_SKR_IW_UMP45);
