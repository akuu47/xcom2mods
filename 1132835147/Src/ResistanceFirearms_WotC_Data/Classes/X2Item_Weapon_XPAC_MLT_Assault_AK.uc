//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_MLT_Assault_AK.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_MLT_Assault_AK extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_MLT_S79_AK);
