//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_Shotgun_Jackhammer.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_Shotgun_Jackhammer extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_MILL_JACKHAMMER);
