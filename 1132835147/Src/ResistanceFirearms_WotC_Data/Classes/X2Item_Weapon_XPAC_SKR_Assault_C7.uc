//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_SKR_Assault_C7.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_SKR_Assault_C7 extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_SKR_S79_C7);
