//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_SKR_Assault_AKS74un.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_SKR_Assault_AKS74un extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_SKR_S79_AKS74U);
