//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_SKR_Assault_M4C.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_SKR_Assault_M4C extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_SKR_MILL_M4C);
