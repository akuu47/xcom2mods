//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_Assault_AK47.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_Assault_HoneyBadger extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_CTM_HONEYBADGER);
