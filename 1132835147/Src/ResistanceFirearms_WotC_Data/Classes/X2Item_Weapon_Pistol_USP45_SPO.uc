//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_Pistol_USP45_SPO.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_Pistol_USP45_SPO extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_MWR_USP45_SPO);
