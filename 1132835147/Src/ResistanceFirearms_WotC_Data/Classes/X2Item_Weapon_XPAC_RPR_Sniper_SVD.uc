//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_RPR_Sniper_SVD.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_RPR_Sniper_SVD extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_RPR_MWR_SVD);
