//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_TMP_Pistol_M9.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_TMP_Pistol_M9 extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_TMP_MWR_M9);
