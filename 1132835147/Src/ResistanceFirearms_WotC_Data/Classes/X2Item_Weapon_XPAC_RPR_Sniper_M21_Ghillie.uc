//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_RPR_Sniper_Widowmaker.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_RPR_Sniper_M21_Ghillie extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_RPR_MWR_M21);
