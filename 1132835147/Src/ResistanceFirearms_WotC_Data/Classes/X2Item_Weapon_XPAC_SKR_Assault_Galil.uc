//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_SKR_Assault_Galil.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_SKR_Assault_Galil extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_SKR_MILL_GALIL);
