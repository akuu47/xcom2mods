//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_TMP_Pistol_Deagle.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_TMP_Pistol_Deagle extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_TMP_MILL_DEAGLE);
