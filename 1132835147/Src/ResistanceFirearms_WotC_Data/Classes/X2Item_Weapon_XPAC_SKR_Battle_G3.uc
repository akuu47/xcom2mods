//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_SKR_Battle_G3.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_SKR_Battle_G3 extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_SKR_MWR_G3);
