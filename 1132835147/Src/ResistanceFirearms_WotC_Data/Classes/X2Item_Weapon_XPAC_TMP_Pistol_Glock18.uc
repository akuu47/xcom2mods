//---------------------------------------------------------------------------------------
// 
//  FILE:   X2Item_Weapon_XPAC_TMP_Pistol_Glock18.uc
//  AUTHOR:  Krakah, E3245
//           
//---------------------------------------------------------------------------------------
class X2Item_Weapon_XPAC_TMP_Pistol_Glock18 extends X2Item dependson(X2CVWPDataStructures) config(_TC_WOTC_TMP_IW_GLOCK18);
